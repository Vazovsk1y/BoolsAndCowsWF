...
namespace BoolsAndCows.Components
{
    ...
    public partial class VRichTextBox : UserControl
    {
        ...
        //        if (!isPlaceholder)
        //            richTextBox1.UseSystemPasswordChar = value;
        //    }
        //}
        ...
        private void SetPlaceholder()
        {
            if (string.IsNullOrWhiteSpace(richTextBox1.Text) && placeholderText != "")
            {
                ...
                //if (isPasswordChar)
                //    richTextBox1.UseSystemPasswordChar = false;
            }
        }
        ...
        private void SetTextBoxRoundedRegion()
        {
            ...
            if (Multiline)
            {
                pathTxt = GetFigurePath(richTextBox1.ClientRectangle, borderRadius - borderSize);
                richTextBox1.Region = new Region(pathTxt);
            }
            else
            {
                pathTxt = GetFigurePath(richTextBox1.ClientRectangle, borderSize * 2);
                richTextBox1.Region = new Region(pathTxt);
            }
            pathTxt.Dispose();
        }
